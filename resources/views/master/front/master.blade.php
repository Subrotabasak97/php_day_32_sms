...
<footer class="pt-5 pb-4 bg-dark">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card card-body rounded-0">
                    ...
                    <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi aperiam architecto consectetur cumque dolor ea esse ex fugiat, impedit incidunt inventore nisi obcaecati perspiciatis placeat porro quia quos velit voluptatibus?</P>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card card-body rounded-0">
            ...
            <div class="col-sm-4">
                ...
                <ul class="nav">
                    ...
                    <li><a href="" class="nav-link"><i class="fab fa-2x fa-reddit-square"></i></a></li>
    ...
    <div class="row">
        <div class="col-12">
            <p class="text-white text-center mb-0">Copyright@2022 All Right Reserved by Nrisimha Sarees</p>
        </div>
    </div>
